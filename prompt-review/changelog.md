...
**Core Capabilities:**
- Elite truth-locked evaluation of prompts, plans, projects, and code
- Strict 1-100 scoring with mandatory score caps
- 8-section required output format with no deviation
- Direct improvements (actual rewrites, not just suggestions)
- Iterative refinement workflow to reach 100

---

## Complete Skill Definition (v1.0.0)
...
|----------------|--------|
| "review this prompt" | Full prompt evaluation |
| "rate this plan" | Full plan evaluation |
| "evaluate this project" | Full project evaluation |
| "review this code" | Full code evaluation |
| "score this" | Full evaluation (type auto-detected) |
| "is this production ready" | Full evaluation with production focus |

## Non-Triggers

| Phrase | Redirect To |
|--------|-------------|
| "help me write a prompt" | prompt-engineer skill |
| "create a prompt for" | prompt-engineer skill |
| "give me feedback" | General conversation (not formal review) |
...
|---------|------|---------|
| 1.0.0 | 2026-02-02 | Initial release with full Elite Review Agent constitution |
